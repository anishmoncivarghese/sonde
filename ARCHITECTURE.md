...
Describes commit 010762a9a79821d49e2607ea3ec1758732288954 plus uncommitted changes.

28 all-test module(s) were excluded. Run `sonde doc --include-tests` to include them.

> **3 file(s) differ from the index used for this document.** Run `sonde index`, then `sonde doc` to refresh.

Cross-module references by how they were resolved: COMPILER 717, LEXICAL 283, HEURISTIC 1803.
...
| `src/cli` | `src/index` | 34 | COMPILER 29, LEXICAL 3, HEURISTIC 2 |
...
| `src/cli` | 3 | 126 | — |
| `src/doc` | 3 | 134 | `DOC_PATH`, `NoDocumentableModulesError`, `action`, `generateDoc`, `renderModuleDetail`, `writeDoc` |
