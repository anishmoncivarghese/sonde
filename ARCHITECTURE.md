...
Describes commit 08efd27486dc1d2effcb4017bd8dfa4000e912c8 plus uncommitted changes.

28 all-test module(s) were excluded. Run `sonde doc --include-tests` to include them.

Cross-module references by how they were resolved: COMPILER 724, LEXICAL 284, HEURISTIC 1817.
...
| `src/cli` | 4 | 132 | — |
| `src/doc` | 3 | 154 | `structuralBody`, `DOC_PATH`, `NoDocumentableModulesError`, `action`, `generateDoc`, `renderModuleDetail`, +2 more |
