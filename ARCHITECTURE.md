...
Describes commit 2621fb3a548eaa5ca2b9fb3d4147d18e9c8296a6 plus uncommitted changes.

28 all-test module(s) were excluded. Run `sonde doc --include-tests` to include them.

Cross-module references by how they were resolved: COMPILER 722, LEXICAL 283, HEURISTIC 1816.
...
| `src/cli` | 3 | 126 | — |
| `src/doc` | 3 | 138 | `structuralBody`, `DOC_PATH`, `NoDocumentableModulesError`, `action`, `generateDoc`, `renderModuleDetail`, +1 more |
